...
//
//		hMacSHA256Service.verifyHMacSHA256(
//		        incomingHmacSignature,
//		        rawBody);
//
//		PaymentRequest reqObj =
//		        getReqObjFromServletReq(wrappedRequest);
//
...
public class HmacFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        // Verify HMAC using RAW request body
        hMacSHA256Service.verifyHMacSHA256(
                incomingHmacSignature,
                rawBody);

        PaymentRequest paymentRequest =
                RequestUtil.extractPaymentRequest(
                        wrappedRequest);

        log.info(
                "HmacFilter: Extracted PaymentRequest: {}",
                paymentRequest);

        log.info(
                "HmacFilter: HMAC signature verified successfully");
        ...
        log.info(
                "HmacFilter: Security context set with authentication");
        ...
        log.info(
                "HmacFilter: Filter chain processed successfully");
    }
}
